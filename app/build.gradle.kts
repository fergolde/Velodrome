...
android {
    ...
    signingConfigs {
        create("release") {
            storeFile = rootProject.file("Fernando.jks")
            storePassword = System.getenv("STORE_PASSWORD") ?: keystoreProperties["storePassword"]?.toString()
    ...
    packaging {
        resources {
            // Optimización: Elimina archivos innecesarios de las librerías que engordan el APK
